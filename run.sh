...
# Sample
# deno run --allow-net --allow-write --allow-read --allow-env src/main.ts --overwrite-template --parseDir C:/git/eden-markdown/sample/ --preview && start http://localhost:8000/Table_of_Contents.html
# Test 
deno run --allow-net --allow-write --allow-read --allow-env src/main.ts --overwrite-template --parseDir C:/git/eden-markdown/tests/ --preview && start http://localhost:8000/Table_of_Contents.html
