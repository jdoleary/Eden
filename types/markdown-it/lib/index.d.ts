...
import utils = require('./common/utils.d.ts');
import helpers = require('./helpers/index.d.ts');
import ParserBlock = require('./parser_block.d.ts');
import ParserCore = require('./parser_core.d.ts');
import ParserInline = require('./parser_inline.d.ts');
import Renderer = require('./renderer.d.ts');
import Token = require('./token.d.ts');

declare namespace MarkdownIt {
    type Token = typeof import('./token.d.ts');
